...
class GameIntro: SKTScene {
    ...
    override func didMoveToView(view: SKView) {
        ...
        story5Block.fontSize = 21
        story5Block.text = "By the way, also take note that the suit you are in is a brand new state of the art prototype suit."
